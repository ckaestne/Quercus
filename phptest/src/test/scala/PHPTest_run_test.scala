...
class PHPTest_run_test extends AbstractPHPTest {
  ...
  @Test def broken669_test004() { testFile("phptest/src/test/resources/run-test/test004.phpt") }
  @Ignore("SKIPIF not supported")@Test def test670_test005() { testFile("phptest/src/test/resources/run-test/test005.phpt") }
  @Test def broken671_test006() { testFile("phptest/src/test/resources/run-test/test006.phpt") }
  @Test def broken672_test007() { testFile("phptest/src/test/resources/run-test/test007.phpt") }
