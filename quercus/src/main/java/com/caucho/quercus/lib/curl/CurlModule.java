...
*/
      ...
      case CURLOPT_HEADERFUNCTION:
        curl.setHeaderCallback(value.toCallable(env, VHelper.noCtx(), false));
        break;
      case CURLOPT_PASSWDFUNCTION:
        curl.setPasswordCallback(value.toCallable(env, VHelper.noCtx(), false));
        break;
      case CURLOPT_READFUNCTION:
        curl.setReadCallback(value.toCallable(env, VHelper.noCtx(), false));
        break;
      case CURLOPT_WRITEFUNCTION:
        curl.setWriteCallback(value.toCallable(env, VHelper.noCtx(), false));
        break;
